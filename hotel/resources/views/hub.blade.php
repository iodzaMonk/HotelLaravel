...
@section('content')
  <div class="flex flex-1 flex-col space-y-16">
    ...
    <form method="GET" action="{{ route('hotels.catalog') }}"
      ...
      <label class="flex flex-col gap-2">
        ...
        <input id="hub-hotel-search" name="destination" placeholder="{{ __('hub.search.destination_placeholder') }}"
          type="text" list="hub-hotel-suggestions" autocomplete="off" data-suggest-url="{{ route('hotels.suggest') }}"
        ...
        <datalist id="hub-hotel-suggestions"></datalist>
      </label>
