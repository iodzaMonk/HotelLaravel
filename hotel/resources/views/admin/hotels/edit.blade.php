...
<section class="mt-10">
  <div class="mx-auto max-w-3xl rounded-3xl bg-white p-10 shadow-xl ring-1 ring-slate-200">
    <div class="mb-8">
      <h1 class="text-3xl font-bold text-slate-900">Update a hotel</h1>
      <p class="mt-2 text-sm text-slate-500">Fill in the details below to update a new hotel to the collection.</p>
    </div>
    ...
    <form action="{{ route('admin.hotels.update', $hotel->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
      ...
      <div class="grid gap-6 md:grid-cols-2">
        <div class="flex flex-col gap-2">
          ...
          <input id="hotel_name" name="hotel_name" type="text" value="{{ $hotel->hotel_name }}"
        ...
        <div class="flex flex-col gap-2">
          ...
          <input id="hotel_address" name="hotel_address" type="text" value="{{ $hotel->hotel_address }}"
